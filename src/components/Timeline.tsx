...
const timelineData = [
  ...
  },
  {
    ...
    subtitle: "Problem Statement Bidding",
  ...
  },
  {
    ...
    title: "Final Sprint",
    subtitle: "& Submission",
    desc: "One final hour to squash bugs, polish presentation slides, and officially submit project links and decks to the portal. Every minute counts.",
    color: "bg-neon-cyan",
    rotate: "rotate-2",
  },
  {
